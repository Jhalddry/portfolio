...
const ProjectCard = ({ title, description, image, gitUrl, previewUrl }: any) => {
  return (
    <div>
      <div
        className="h-72 w-full md:h-72 rounded-t-xl relative group"
        style={{ background: `url(${image})`, backgroundSize: "contain", backgroundPosition: "center", backgroundRepeat: "no-repeat" }}
      >
